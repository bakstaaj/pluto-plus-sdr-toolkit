...
# install_audio_monitor_wbfm.sh
#
# Run from repository root:
#   cd ~/sdrdev/pluto_native_test
#   ./tools/install_audio_monitor_wbfm.sh
#
# This script assumes you extracted the package to:
#   C:\Users\jim\Downloads\PlutoAudioMonitorWBFM

PACKAGE_ROOT_WINDOWS="${PACKAGE_ROOT_WINDOWS:-C:\\Users\\jim\\Downloads\\PlutoAudioMonitorWBFM}"
...
if [ ! -d "$PACKAGE_ROOT" ]; then
    ...
    echo
    echo "Extract PlutoAudioMonitorWBFM.zip into:"
    echo "  C:\\Users\\jim\\Downloads\\PlutoAudioMonitorWBFM"
    exit 1
fi
...
cp "$PACKAGE_ROOT/docs/WBFM_AUDIO.md" docs/WBFM_AUDIO.md
cp "$PACKAGE_ROOT/launchers/run_fm_audio.cmd" launchers/run_fm_audio.cmd
...
echo "  ./build/native/pluto_audio_monitor.exe --preset fm-100 --seconds 20 --squelch-off --wav sessions/fm100.wav --csv sessions/audio_log.csv"
